...
public class RequestedProduct{
	...
	private List<RequestedProductSize> requestedProductSize;
	...
	public List<RequestedProductSize> getRequestedProductSize() {
		return requestedProductSize;
	}

	public void setRequestedProductSize(List<RequestedProductSize> requestedProductSize) {
