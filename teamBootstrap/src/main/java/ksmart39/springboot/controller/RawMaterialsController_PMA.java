...
public class RawMaterialsController_PMA {
	
	private static final Logger log = LoggerFactory.getLogger(RawMaterialsController_PMA.class);
	...
	@Autowired
	public RawMaterialsController_PMA(RawMaterialsInventoryStatusService materialsInventoryStatusService) {
